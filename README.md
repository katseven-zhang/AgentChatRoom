...
浏览器与 EXE 面板共用同一套现代高质感前端：
- **科技藏青紫蓝高质感调色板（Linear / Cursor 范式）**：全站主色彻底废除老旧沉闷的森林绿，升级为高级科技藏青蓝（`#4338ca` / 深色 `#a5b4fc`），绿色仅收敛至在线与通过等纯状态语义；新人向导与侧栏选中态彻底告别泥泞绿底，升级为细腻微阴影悬浮卡片；浏览器标签图标（`favicon.svg`）与顶栏品牌标同步升级为科技藏青紫蓝双色微渐变。
